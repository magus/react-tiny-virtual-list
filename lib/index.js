...
var VirtualList = (_temp2 = _class = function (_PureComponent) {
  ...
  VirtualList.prototype.scrollTo = function scrollTo(value) {
    ...
    var currentScroll = this.rootNode[_constants.scrollProp[scrollDirection]];
    ...
    this.lastScroll = (0, _animateScroll2.default)(this.rootNode, value, animationDuration);
  };
  ...
  VirtualList.prototype.getStyle = function getStyle(index) {
    ...
    return this._styleCache[index] = _extends({}, STYLE_ITEM, (_extends2 = {}, _extends2[_constants.sizeProp[scrollDirection]] = size, _extends2.transform = _constants.positionProp[scrollDirection] + '(' + offset + 'px)', _extends2));
  };
  ...
  VirtualList.prototype.render = function render() {
    ...
    var innerStyle = _extends({}, STYLE_INNER, (_extends3 = {}, _extends3[_constants.sizeProp[scrollDirection]] = totalSize, _extends3));
...
process.env.NODE_ENV !== "production" ? VirtualList.propTypes = {
  ...
  displayBottomUpwards: _propTypes2.default.bool,
